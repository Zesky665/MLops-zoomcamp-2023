...
- `@task(retries=3, retry_delay_seconds=2, name="Read taxi data")` - This one. See [docs](https://docs.prefect.io/2.10.12/api-ref/prefect/tasks/)
...
- `0 9 3 * *` - this one. The values are min,hour,day,month,year.
- `0 0 9 3 *`
- `9 * 3 0 *`
- `* * 9 3 0`
...
- `send_email_message`
- `email_send_message` - This. Can check in the [docs](https://prefecthq.github.io/prefect-email/). I used the UI. 
- `send_email`
- `send_message`
